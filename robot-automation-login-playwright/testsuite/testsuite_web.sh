...
CUSTOM_REPORT_SCRIPT="${PROJECT_ROOT}/robot-automation-login-playwright/function/CustomReportGenerator.py"
...
robot \
  ...
  --argumentfile "${PROJECT_ROOT}/robot-automation-login-playwright/testsuite/testcase-list/web.txt" \
  "${TESTCASE_PATH}"
